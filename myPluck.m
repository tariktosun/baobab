function y = myPluck(len,d,r,x,viz)
% y = pluck(l,d,r,x,v)   Plucked string synthesis via pair of waveguide 'rails'
...
%    v if present and nonzero plots waves & string at each samfple time.
...
for t = 1:d
  ...
  [left, right] = stepWaveguide(left, right, len, r);
